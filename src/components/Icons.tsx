...
export function IconRun({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><circle cx="13" cy="4" r="1.5" /><path d="M6 20l4-8 2 3 3-5 3 5" /><path d="M8 12l2-4 3 2" /></svg>;
}

export function IconBriefcase({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" /><line x1="12" y1="12" x2="12" y2="12" /></svg>;
}

export function IconCalendarOff({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /><path d="M9 16l2 2 4-4" strokeWidth={1.6} /></svg>;
}

export function IconMapPin({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><path d="M12 21s-7-6.5-7-11a7 7 0 1 1 14 0c0 4.5-7 11-7 11z" /><circle cx="12" cy="10" r="2.5" /></svg>;
}

export function IconSearch({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><circle cx="11" cy="11" r="7" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>;
}

export function IconGrid({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><rect x="3" y="3" width="7" height="7" rx="1" /><rect x="14" y="3" width="7" height="7" rx="1" /><rect x="3" y="14" width="7" height="7" rx="1" /><rect x="14" y="14" width="7" height="7" rx="1" /></svg>;
}

export function IconUsers({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>;
}

export function IconClipboard({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /><rect x="8" y="2" width="8" height="4" rx="1" /></svg>;
}

export function IconInbox({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><polyline points="22 12 16 12 14 15 10 15 8 12 2 12" /><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z" /></svg>;
}

export function IconCalendar({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" /></svg>;
}
...
export function IconMessageSquare({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>;
}

export function IconShield({ size = 28 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg>;
}

export function IconLogo({ size = 20 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" /><rect x="9" y="3" width="6" height="4" rx="1" /><path d="M9 12l2 2 4-4" /></svg>;
}

export function IconChevronRight({ size = 16 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><polyline points="9 18 15 12 9 6" /></svg>;
}

export function IconDownload({ size = 18 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg>;
}

export function IconPlus({ size = 18 }: { size?: number }) {
    return <svg {...props} width={size} height={size}><line x1="12" y1="5" x2="12" y2="19" /><line x1="5" y1="12" x2="19" y2="12" /></svg>;
}
